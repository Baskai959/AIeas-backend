...
type CreateLiveAnalysisReportInput struct {
	ActorID       string
...
type LiveAnalysisCallbackInput struct {
	RequestID       string
	Success         bool
	Status          string
	Summary         string
...
type LiveAnalysisService struct {
	reports   repository.LiveAnalysisReportRepository
	sessions  repository.LiveSessionRepository
	requester LiveAnalysisRequester
	options   LiveAnalysisOptions
}

func NewLiveAnalysisService(reports repository.LiveAnalysisReportRepository, sessions repository.LiveSessionRepository, requester LiveAnalysisRequester, options LiveAnalysisOptions) *LiveAnalysisService {
	if reports == nil {
		reports = repository.NewMemoryLiveAnalysisReportRepository()
	}
	if requester == nil {
		requester = DisabledLiveAnalysisRequester{}
	}
...
func (s *LiveAnalysisService) CreateReport(ctx context.Context, in CreateLiveAnalysisReportInput) (LiveAnalysisTask, error) {
...
func (s *LiveAnalysisService) startAttempt(ctx context.Context, task *LiveAnalysisTask) (LiveAnalysisTask, error) {
	...
	result, err := s.requester.RequestLiveAnalysis(ctx, LiveAnalysisAsyncInput{
		Prompt:      task.Prompt,
...
func (s *LiveAnalysisService) HandleCallback(ctx context.Context, in LiveAnalysisCallbackInput) (LiveAnalysisTask, error) {
	if s == nil || s.reports == nil {
...
func (s *LiveAnalysisService) findCallbackTask(ctx context.Context, in LiveAnalysisCallbackInput) (LiveAnalysisTask, error) {
...
func liveAnalysisCallbackStale(task LiveAnalysisTask, in LiveAnalysisCallbackInput) bool {
...
func liveAnalysisCallbackTaskID(in LiveAnalysisCallbackInput) string {
...
func liveAnalysisCallbackErrorMessage(in LiveAnalysisCallbackInput) string {
