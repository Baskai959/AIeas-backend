...
func NewDepositReconciler(auctions auctionports.AuctionRepository, deposits auctionports.DepositRepository, realtime auctionports.AuctionRealtimeStore, interval time.Duration) *DepositReconciler {
	if interval <= 0 {
