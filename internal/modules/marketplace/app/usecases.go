...
type MarketplaceUseCase interface {
	...
	SearchMerchants(ctx context.Context, keyword string, limit, offset int) ([]domain.MerchantView, error)
	GetMerchant(ctx context.Context, merchantID string) (domain.MerchantView, error)
}
