...
--    {"stepCent":50000}]
--   语义：以「上一价」落在哪个 tier 决定 stepCent；
...
VALUES
  ...
  (90001, 90001, 2001, 90001, 'ENGLISH',  10000,   20000,
   JSON_ARRAY(JSON_OBJECT('maxPriceCent',50000,'stepCent',1000),
              JSON_OBJECT('maxPriceCent',200000,'stepCent',5000),
              JSON_OBJECT('maxPriceCent',1000000,'stepCent',20000),
              JSON_OBJECT('stepCent',50000)),
   ...
   JSON_OBJECT('startPriceCent',10000,'reservePriceCent',20000,'depositAmountCent',8000,
               ...
               'incrementRule',JSON_ARRAY(JSON_OBJECT('maxPriceCent',50000,'stepCent',1000),
                                          JSON_OBJECT('maxPriceCent',200000,'stepCent',5000),
                                          JSON_OBJECT('maxPriceCent',1000000,'stepCent',20000),
                                          JSON_OBJECT('stepCent',50000))),
